...
WITH SCHEMABINDING 
AS
SELECT                   SUM(dbo.Phase2ComponentValuation.Gross) AS GROSSMV
						 , SUM(dbo.Phase2ComponentValuation.FairValue) AS FairValue
						 , dbo.ValuationApproachView.AssetOid
						 , SUM(dbo.Phase2ComponentValuation.DeprExp_Total) AS Depreciation_Expense
						 , SUM(dbo.Phase2ComponentValuation.DeprAmount_Total) AS DepricitableAmount
						 , dbo.ValuationApproachView.CurrentValuation AS ValuationId
						 , SUM(dbo.Phase2ComponentValuation.Gross) - SUM(dbo.Phase2ComponentValuation.FairValue) AS Accumulated_Depreciation
